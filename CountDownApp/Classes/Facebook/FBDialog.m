...
- (void)sizeToFitOrientation:(BOOL)transform {
  ...
  _orientation = (int)[UIApplication sharedApplication].statusBarOrientation;
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request
  ...
  if ([url.scheme isEqualToString:@"fbconnect"]) {
    ...
    return NO;
  } else if (self.loadingURL != nil && [self.loadingURL isEqual:url]) {
    return YES;
...
- (void)deviceOrientationDidChange:(void*)object {
  UIDeviceOrientation orientation = (int)[UIApplication sharedApplication].statusBarOrientation;
