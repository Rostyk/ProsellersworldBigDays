...
- (void) initImages
{
    ...
    if (isMinus == YES)
    {
        ...
        /*
        mImageViewTop	 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JDFlipNumberView.bundle/__.png"]];
        mImageViewTop.frame = CGRectMake(0, 0, 14, 28);
        mImageViewBottom = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JDFlipNumberView.bundle/__.png"]];
        mImageViewBottom.frame = CGRectMake(0, 0, 14, 28);
        mImageViewFlip	 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"JDFlipNumberView.bundle/__.png"]];
        mImageViewFlip.frame = CGRectMake(0, 0, 14, 28);
        mImageViewBottom.hidden = YES;
