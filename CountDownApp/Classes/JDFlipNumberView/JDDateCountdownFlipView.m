...
- (void) setTargetDate: (NSDate*) targetDate
{
    ...
    if (compare == NSOrderedDescending || compare == NSOrderedSame) {
        ...
        /*
        mFlipNumberViewDay.intValue    = 0;
        mFlipNumberViewHour.intValue   = 0;
        mFlipNumberViewMinute.intValue = 0;
        mFlipNumberViewSecond.intValue = 0;
...
- (void) setFrame: (CGRect) rect
{
    if (nNumberType == 0) {
        ...
        /*
        for (JDGroupedFlipNumberView* view in [NSArray arrayWithObjects: mFlipNumberViewSecond, nil])
        {
            currentX   += margin;
